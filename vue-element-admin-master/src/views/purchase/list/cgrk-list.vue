<template>
    <div class="order">
        <div class="order-list">
            ...
            >
                <el-table-column label="采购入库单编号" width="200" prop="id">
                ...
                <el-table-column label="入库日期" width="120" prop="id">
                    <template slot-scope="scope">{{
                        scope.row.stockingDate | filterDate
                    }}</template>
                </el-table-column>
                ...
                <el-table-column prop="approvalBy" label="审批人员" width="120">
                 ...
                 <el-table-column label="关联的预入库单"  prop="relatedFromId">
...
<script>
import { getPurchaseStockinList } from "@/api/purchase";
...
export default {
    ...
    methods: {
        getList() {
            ...
            getPurchaseStockinList(this.listQuery).then((res) => {
