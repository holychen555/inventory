            ...
            <el-collapse>
                <el-collapse-item>
                    <div slot="title" class="filter-condiction__default">
                        ...
                        <el-tag>
                            供应商：{{
                                showVendorName(listQuery.vendorId) ? showVendorName(listQuery.vendorId) : "全部"
                            }}
                        </el-tag>
                        <el-tag>
                            采购人员：
    ...
    watch: {
        listQuery: {
            handler(val){
                ...
                if(this.returnDate){
                    query.returnDate = this.returnDate[0]+'/'+this.returnDate[1].slice(0,10)+' 23:59:59';
                }
        ...
        returnDate(val){
            let query = {...this.listQuery};
            query.returnDate = val[0]+'/'+val[1].slice(0,10)+' 23:59:59';
             console.log('query',query);
            this.$emit('changeListQuery',query);
        }
    },
