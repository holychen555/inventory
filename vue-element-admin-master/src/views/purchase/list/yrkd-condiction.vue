                        ...
                        >
                            <el-form-item label="到货日期">
                                ...
                                <el-date-picker
                                    ...
                                    size="mini"
                                    v-if="listQuery.arrivalDate == '自定义'"
                                    v-model="arrivalDate"
                                    type="daterange"
                                    range-separator="至"
    ...
    watch: {
        listQuery: {
            handler(val){
                ...
                if(this.arrivalDate){
                    query.arrivalDate = this.arrivalDate[0]+'/'+this.arrivalDate[1].slice(0,10)+' 23:59:59';
                }
        ...
        arrivalDate(val){
            let query = {...this.listQuery};
            query.arrivalDate = val[0]+'/'+val[1].slice(0,10)+' 23:59:59';
             console.log('query',query);
            this.$emit('changeListQuery',query);
        }
    },
