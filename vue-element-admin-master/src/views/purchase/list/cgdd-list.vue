<template>
    <div class="order">
        <div class="order-list">
            ...
            >
                <el-table-column label="采购单编号" width="200" prop="id">
                ...
                <el-table-column prop="approvalBy" label="审批人员" width="120">
                 ...
                 <el-table-column label="关联的预采购单"  prop="relatedFromId" width="200">
                  ...
                  <el-table-column label="关联的预入库单"  prop="relatedFromId" width="200">
...
export default {
    ...
    methods: {
        getList() {
            ...
            getPurchaseList(this.listQuery).then((res) => {
