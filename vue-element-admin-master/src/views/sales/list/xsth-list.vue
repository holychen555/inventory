<template>
    <div class="order">
        <div class="order-list">
            ...
            >
                <el-table-column label="销售退货单编号" width="200" prop="id">
                  ...
                  <el-table-column label="关联销售出库单编号" width="200" prop="id">
...
<script>
import { getSalesReturnList } from "@/api/sales";
...
export default {
    ...
    methods: {
        getList() {
            ...
            getSalesReturnList(this.listQuery).then((res) => {
