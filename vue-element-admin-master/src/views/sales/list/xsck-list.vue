<template>
    <div class="order">
        <div class="order-list">
            ...
            >
                <el-table-column label="销售出库单编号" width="200" prop="id">
                ...
                <el-table-column label="关联的销售单"  prop="relatedFromId" width="200">
                    <template slot-scope="scope">
                        <router-link
                            :to="'/sales/detail/'+scope.row.relatedFromId" 
                        >
                            <span class="order-id">{{scope.row.relatedFromId}}</span>
                        </router-link>
                    </template>
                </el-table-column>
                 <el-table-column label="关联的销售退货单"  prop="relatedToId" width="200">
                    <template slot-scope="scope">
                        <router-link
...
<script>
import { getSalesStockoutList } from "@/api/sales";
...
export default {
    ...
    methods: {
        getList() {
            ...
            getSalesStockoutList(this.listQuery).then((res) => {
